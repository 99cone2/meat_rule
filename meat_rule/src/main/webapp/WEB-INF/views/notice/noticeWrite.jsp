				...
				<table class="table">
					<tr>
						...
						<td width=85% class="text-left fgl">				
							<input style="width: 350px;" type="text" name="mem_id" placeholder="이름을 입력해 주세요" class="bordered-input" value="${mem_id}" readonly/>
					</tr>
					<tr>
						<th width=10% class="text-center fg lb fw">제목</th>
						<td width=90% class="text-left fgl">
						<input style="width: 700px;" type="text" name="notice_title" class="bordered-input" placeholder="제목을 입력해 주세요" /></td>
					</tr>
					<tr>
						<th width="10%" class="text-center fg lb fw" style="vertical-align: middle;">공지 내용</th>
						<td colspan="4" class="text-left fg" valign="top" height="200">
							<pre class="fgl" style="white-space: pre-wrap; border: none; background-color: white;">
								<textarea cols="80" rows="8" name="notice_content" placeholder="내용을 입력해 주세요" class="bordered-input" style="width: 100%; height: 100%; padding: 0; margin: 0;"></textarea>
							</pre>
						</td>
					</tr>
					<tr>
