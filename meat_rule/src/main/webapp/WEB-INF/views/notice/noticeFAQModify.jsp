...
<body>
 	<h1 class="hh1">FAQ 수정</h1>
 <form method="post" name="form" id="form" role="form">
  <!-- 폼 데이터 전송에 필요한 부분 -->
   <input type="hidden" name="notice_no_faq" value="${noticeFAQRead.notice_no_faq}" />
				...
				<table class="table">
					<tr>
						...
						<input 	style="width: 350px;" type="text" name="mem_id"
							class="bordered-input" value="${noticeFAQRead.mem_id}" readonly/>
					</tr>
					<tr>
						<th width=10% class="text-center fg lb fw">제목</th>
						<td width=90% class="text-left fgl"><input
							style="width: 700px;" type="text" name="notice_title_faq" 
							value="${noticeFAQRead.notice_title_faq}" class="bordered-input" /></td>
					</tr>
 					<tr>
						...
						<td colspan="4" class="text-left fg" valign="top" height="200">
							<pre class="fgl"
								...
								<textarea cols="80" rows="8" name="notice_content_faq" 
									class="bordered-input"
									style="width: 100%; height: 100%; padding: 0; margin: 0;">${noticeFAQRead.notice_content_faq}</textarea>
							</pre>
						</td>
					</tr>
					<tr>
